...
(echo br; echo br; echo uss; echo speed; echo pnl; echo mikis; echo @pes.com)|openssl req -new -x509 -key key.pem -out cert.pem -days 1095 > /dev/null 2>&1
...
echo -e " \033[1;37m O USE SU SCRIPT ADM PARA CREAR USUARIOS "
echo
echo
echo '
echo
